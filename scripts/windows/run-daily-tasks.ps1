...
generate predictions, run backtest, refresh reliability calibration, auto-place reliability
bets, settle paper bets, sync PuntersEdge odds, prune stale PuntersEdge snapshots.
